...
export default class ScreenPrivacyTerms extends XScreenFit {
    html() {
        return `
		    <h1>KYC Procedure, Data Collection and Retention</h1>
		    <section>
                ...
                <p>If the verification procedure is successful, Nimiq will then send your full name and birth date to ComplyAdvantage to perform a Global Sanctions, Watchlist and Politically Exposed Persons check to ensure that you are not prohibited from participating in the NIM Activation. ComplyAdvantage does not retain any of the Personal Information obtained by Nimiq.</p>
